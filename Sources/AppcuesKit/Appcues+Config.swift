...
public extension Appcues {
    ...
    class Config: NSObject {
        ...
        /// Sets the additional auto properties for the configuration. These properties are included by the SDK
        /// in the set of auto properties sent on every tracked analytics event. The additional property names must be unique
        /// from those already captured in the SDK. If a property name conflicts with an existing auto property generated by the SDK,
        /// it is ignored.
        ///
        ...
        public func additionalAutoProperties(_ additionalAutoProperties: [String: Any]) -> Self {
            self.additionalAutoProperties = additionalAutoProperties
            return self
        }
    }
}
