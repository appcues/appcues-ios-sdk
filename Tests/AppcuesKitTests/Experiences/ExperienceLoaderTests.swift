...
class ExperienceLoaderTests: XCTestCase {
    ...
    func testLoadPublished() throws {
        ...
        appcues.experienceRenderer.onShowExperience = { experience, completion in
            ...
            guard case .showCall = experience.triggeredBy else { return XCTFail() }
            completion?(.success(()))
        }
        ...
        // Act
        experienceLoader.load(experienceID: "123", published: true, triggeredBy: .showCall) { result in
    ...
    func testLoadUnpublished() throws {
        ...
        appcues.experienceRenderer.onShowExperience = { experience, completion in
            ...
            guard case .preview = experience.triggeredBy else { return XCTFail() }
            completion?(.success(()))
        }
        ...
        // Act
        experienceLoader.load(experienceID: "123", published: false, triggeredBy: .preview) { result in
            if case .success = result {
                completionExpectation.fulfill()
            }
        }
    ...
    func testLoadFail() throws {
        ...
        // Act
        experienceLoader.load(experienceID: "123", published: true, triggeredBy: .unknown) { result in
    ...
    func testReloadPreviewNotification() throws {
        ...
        experienceLoader.load(experienceID: "123", published: false, triggeredBy: .preview, completion: nil)
    ...
    func testNoOpWhenNotificationOnPublishedExperiencec() throws {
        ...
        experienceLoader.load(experienceID: "abc", published: true, triggeredBy: .showCall, completion: nil)
