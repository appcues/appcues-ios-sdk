...
class AnalyticsTrackerTests: XCTestCase {
    ...
    func testIdentifyRequestBody() throws {
        ...
        let update = TrackingUpdate(type: .profile, properties: ["my_key":"my_value", "another_key": 33], userID: "specific-user-id")
    ...
    func testTrackEventRequestBody() throws {
        ...
        let update = TrackingUpdate(type: .event("eventName"), properties: ["my_key":"my_value", "another_key": 33], userID: "my-anonymous-id")
    ...
    func testTrackScreenRequestBody() throws {
        ...
        let update = TrackingUpdate(type: .screen("My test page"), properties: ["my_key":"my_value", "another_key": 33], userID: "my-anonymous-id")
