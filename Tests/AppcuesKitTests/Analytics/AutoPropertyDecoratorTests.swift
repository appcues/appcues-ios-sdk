...
class AutoPropertyDecoratorTests: XCTestCase {
    ...
    func testScreen() throws {
        ...
        let expectedEventAutoPropertyKeys = ["userId",  "_deviceModel", "_timezoneOffset", "_timezoneCode", "_bundlePackageId", "_lastBrowserLanguage", "_localId", "_appName", "_lastSeenAt", "_updatedAt", "_sdkVersion", "_osVersion", "_operatingSystem", "_deviceType", "_appVersion", "_isAnonymous", "_appBuild", "_sdkName", "_appId", "_sessionPageviews", "_currentScreenTitle", "_sessionId", "_pushPrimerEligible"]
    ...
    func testEvent() throws {
        ...
        XCTAssertEqual([], Set(try XCTUnwrap(decorated.properties).keys).symmetricDifference(expectedPropertyKeys))
        let expectedEventAutoPropertyKeys = ["userId",  "_deviceModel", "_timezoneOffset", "_timezoneCode", "_bundlePackageId", "_lastBrowserLanguage", "_localId", "_appName", "_lastSeenAt", "_updatedAt", "_sdkVersion", "_osVersion", "_operatingSystem", "_deviceType", "_appVersion", "_isAnonymous", "_appBuild", "_sdkName", "_appId", "_sessionPageviews", "_sessionRandomizer", "_sessionId", "_pushPrimerEligible"]
        XCTAssertEqual([], Set(try XCTUnwrap(decorated.identityAutoProperties).keys).symmetricDifference(expectedEventAutoPropertyKeys))
        let expectedEventDeviceAutoPropertyKeys = ["_deviceId", "_language", "_pushToken", "_pushEnabledBackground", "_pushEnabled", "_pushEnvironment", "_deviceType", "_appBuild", "_appId", "_operatingSystem", "_bundlePackageId", "_deviceModel", "_timezoneOffset", "_timezoneCode", "_appVersion", "_sdkVersion", "_osVersion", "_sdkName", "_appName"]
    ...
    func testProfile() throws {
        ...
        let expectedContextKeys = ["app_id", "app_version"]
        XCTAssertEqual([], Set(try XCTUnwrap(decorated.context).keys).symmetricDifference(expectedContextKeys))
        let expectedPropertyKeys = ["CUSTOM", "userId",  "_deviceModel", "_timezoneOffset", "_timezoneCode", "_bundlePackageId", "_lastBrowserLanguage", "_localId", "_appName", "_lastSeenAt", "_updatedAt", "_sdkVersion", "_osVersion", "_operatingSystem", "_deviceType", "_appVersion", "_isAnonymous", "_appBuild", "_sdkName", "_appId", "_sessionPageviews", "_sessionId", "_pushPrimerEligible"]
        XCTAssertEqual([], Set(try XCTUnwrap(decorated.properties).keys).symmetricDifference(expectedPropertyKeys))
    ...
    func testProfilePropertiesOnSubsequentEvent() throws {
        ...
        XCTAssertEqual([], Set(try XCTUnwrap(decorated.properties).keys).symmetricDifference(expectedPropertyKeys))
        let expectedEventAutoPropertyKeys = ["userId",  "_deviceModel", "_timezoneOffset", "_timezoneCode", "_bundlePackageId", "_lastBrowserLanguage", "_localId", "_appName", "_lastSeenAt", "_updatedAt", "_sdkVersion", "_osVersion", "_operatingSystem", "_deviceType", "_appVersion", "_isAnonymous", "_appBuild", "_sdkName", "_appId", "_sessionPageviews", "_sessionId", "_pushPrimerEligible", "PROFILE_PROPERTY"]
        XCTAssertEqual([], Set(try XCTUnwrap(decorated.identityAutoProperties).keys).symmetricDifference(expectedEventAutoPropertyKeys))
        XCTAssertNil(decorated.deviceAutoProperties)
    }
}
