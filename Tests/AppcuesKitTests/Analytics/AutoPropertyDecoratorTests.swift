...
class AutoPropertyDecoratorTests: XCTestCase {
    ...
    func testScreen() throws {
        ...
        XCTAssertEqual(
            ...
            Set(try XCTUnwrap(decorated.eventAutoProperties).keys)
                .symmetricDifference(["userId",  "_deviceModel", "_bundlePackageId", "_lastBrowserLanguage", "_localId", "_userAgent", "_appName", "_updatedAt", "_sdkVersion", "_osVersion", "_operatingSystem", "_deviceType", "_appVersion", "_isAnonymous", "_appBuild", "_sdkName", "_appId", "_sessionPageviews", "_currentScreenTitle"])
        )
    }
    ...
    func testEvent() throws {
        ...
        XCTAssertEqual(
            [],
            Set(try XCTUnwrap (decorated.eventAutoProperties).keys)
                .symmetricDifference(["userId",  "_deviceModel", "_bundlePackageId", "_lastBrowserLanguage", "_localId", "_userAgent", "_appName", "_updatedAt", "_sdkVersion", "_osVersion", "_operatingSystem", "_deviceType", "_appVersion", "_isAnonymous", "_appBuild", "_sdkName", "_appId", "_sessionPageviews", "_sessionRandomizer"])
        )
    }
    ...
    func testProfile() throws {
        ...
        XCTAssertEqual(
            [],
            Set(try XCTUnwrap(decorated.properties).keys)
                .symmetricDifference(["CUSTOM", "userId",  "_deviceModel", "_bundlePackageId", "_lastBrowserLanguage", "_localId", "_userAgent", "_appName", "_updatedAt", "_sdkVersion", "_osVersion", "_operatingSystem", "_deviceType", "_appVersion", "_isAnonymous", "_appBuild", "_sdkName", "_appId", "_sessionPageviews"])
        )
